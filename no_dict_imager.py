...
class PictureRejigger:
    ...
    def __init__(
        ...
        # self.blurred_image = Image.open(self.input_image)
    ...
    def get_rgb_dict_from_new_pixels(self):
        ...
        for image in os.listdir(self.input_pixels):
            ...
            picture_dict[select_image_path] = select_image.resize((1, 1)).getpixel((0, 0))[:-1]
    ...
    def compare_pixel_to_input_images(self, input_rgb):
        ...
        for image_path in self.pixel_rgb.keys():
            ...
            # print(input_rgb)
            # print(self.pixel_rgb[image_path])

            difference = self.get_colour_difference(
                input_rgb, self.pixel_rgb[image_path]
            )
